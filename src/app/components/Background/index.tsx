  ...
  return (
    <>
      <Image
        ...
        className="opacity-80 brightness-125 absolute top-0 left-0 h-[15rem] w-auto"
      />

      <Image
        src={flowerTopRight}
        alt="Flor superior direita"
        className="opacity-80 brightness-125 absolute top-0 right-0 h-[20rem] w-auto"
      />

      <Image
        src={flowerBottomRight}
        alt="Flor inferior direita"
        className="opacity-80 brightness-125 absolute bottom-0 right-0 h-[10rem] w-auto"
      />

      <Image
        src={flowerBottomLeft}
        alt="Flor inferior esquerda"
        className="opacity-80 brightness-125 absolute bottom-0 left-0 h-[13rem] w-auto"
      />
    </>
  );
};
